...
void man(char *name)
{
   ...
   {
      printf("Discription : Used to list all information of file\n");
      printf("Usage : ls\n");
   }
   ...
   {
      printf("Discription : Used to removed data from file\n");
   ...
   {
      printf("Discription : Used to close all opened files\n");
   ...
   {
      printf("Discription : Used to delete the files\n");
      ...
      else if(count == 2)
      {
         ...
         else if(count == 3)
         {
            ...
            else if(strcmp(command[0],"read")==0)
            {
               ...
               if(ptr == NULL)
               {
                  printf("Erroor : Memory allocation Failure\n");
                  continue;
               }
         ...
         else if(count == 4)
         {
            if(strcmp(command[0],"lseek")==0)
            {
               ...
               if(ret == -1)
               {
                  printf("Error : Unabled to Perform Lseek\n");
               }
            }
            else
            {
